...
export const notificationTypeEnum = pgEnum('notification_type', ['TASK', 'IMPORT', 'SYSTEM']);
export type NotificationType = (typeof notificationTypeEnum.enumValues)[number];

export const notificationEntityEnum = pgEnum('notification_entity', ['IMPORT', 'TASK']);
export type NotificationEntity = (typeof notificationEntityEnum.enumValues)[number];
